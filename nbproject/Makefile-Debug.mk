...
${OBJECTDIR}/src/crc32.o: src/crc32.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -Isrc/lzma -Isrc/lzma/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/crc32.o src/crc32.cpp

${OBJECTDIR}/src/lzma/lzma_compress.o: src/lzma/lzma_compress.c
	${MKDIR} -p ${OBJECTDIR}/src/lzma
	${RM} "$@.d"
	$(COMPILE.c) -g -Isrc -Isrc/lzma -Isrc/lzma/inc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lzma/lzma_compress.o src/lzma/lzma_compress.c

${OBJECTDIR}/src/lzma/src/7zFile.o: src/lzma/src/7zFile.c
	${MKDIR} -p ${OBJECTDIR}/src/lzma/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Isrc -Isrc/lzma -Isrc/lzma/inc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lzma/src/7zFile.o src/lzma/src/7zFile.c

${OBJECTDIR}/src/lzma/src/LzFind.o: src/lzma/src/LzFind.c
	${MKDIR} -p ${OBJECTDIR}/src/lzma/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Isrc -Isrc/lzma -Isrc/lzma/inc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lzma/src/LzFind.o src/lzma/src/LzFind.c

${OBJECTDIR}/src/lzma/src/LzmaDec.o: src/lzma/src/LzmaDec.c
	${MKDIR} -p ${OBJECTDIR}/src/lzma/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Isrc -Isrc/lzma -Isrc/lzma/inc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lzma/src/LzmaDec.o src/lzma/src/LzmaDec.c

${OBJECTDIR}/src/lzma/src/LzmaEnc.o: src/lzma/src/LzmaEnc.c
	${MKDIR} -p ${OBJECTDIR}/src/lzma/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Isrc -Isrc/lzma -Isrc/lzma/inc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lzma/src/LzmaEnc.o src/lzma/src/LzmaEnc.c

${OBJECTDIR}/src/main.o: src/main.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -Isrc/lzma -Isrc/lzma/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.cpp
